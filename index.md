...
humandate: "May 10 and 12, 2022"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Renata Curty", "Ryan Horne"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
...
collaborative_notes:  https://pad.carpentries.org/2022-05-10-ucsb-webscraping # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
eventbrite: 293511469707  # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
...
{% else %}
<p><a href="https://ucsb.co1.qualtrics.com/jfe/form/SV_0rl86kNKrlAtAJU">Pre-workshop Survey</a></p>
<p><a href="https://ucsb.co1.qualtrics.com/jfe/form/SV_8qq5hTo7pLZ2Aku">Post-workshop Survey</a></p>
{% endif %}
...
<p>
  ...
  {% endif %}
  workshop,
  you will need access to software as described on the <a href="https://github.com/UCSBCarpentry/2022-05-10-ucsb-webscraping/setup.html"><strong>Setup Page</strong></a>.
